...
### [Done] 날씨 API KMA/OpenWeather 하이브리드 전환

2026-07-05 로컬 검증 결과를 바탕으로, 한국 도시는 기상청 API(KMA), 해외 도시는 OpenWeather를 사용하는 하이브리드 구조를 적용했다.
...
- KMA와 OpenWeather 공통성이 낮은 기압, 가시거리, 돌풍은 기본 지표에서 제외
